...
var SignalLookup = map[string]os.Signal{
	...
	"SIGBUS": syscall.SIGBUS, "SIGCONT": syscall.SIGCONT, "SIGFPE": syscall.SIGFPE,
	...
	"SIGTTIN": syscall.SIGTTIN, "SIGTTOU": syscall.SIGTTOU, "SIGUSR1": syscall.SIGUSR1,
	"SIGUSR2": syscall.SIGUSR2, "SIGWINCH": syscall.SIGWINCH, "SIGXCPU": syscall.SIGXCPU,
